...
def deploy_cull(rpc_url: str, deploy_account: LocalAccount) -> tuple[ChecksumAddress, Contract]:
    ...
    base_token_contract_addr, _ = deploy_contract_and_return(
        web3,
    ...
    cull_address, cull_generic_contract = deploy_contract_and_return(web3=web3, abi=abi, bytecode=bytecode, deploy_account_addr=deploy_account_addr, args=args)
    cull_contract = CullProtocolContract(web3_instance=web3, address=cull_address, abi=abi)
